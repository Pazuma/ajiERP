...
def execute():
    """Add Safety Stock Status report under Stock workspace sidebar Reports section."""
    sidebar_name = "Stock"
    if not frappe.db.exists("Workspace Sidebar", sidebar_name):
        return

    # Reload report from app
    frappe.reload_doc("client_akivision", "report", "safety_stock_status", force=True)
    ...
    report_name = "Safety Stock Status"
    label = "安全库存状态"
